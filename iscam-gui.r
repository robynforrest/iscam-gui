      ...
      switch(pType,
          ...
          # Can delete this special one after ARF assessment
           ...
           "sSelexLogisticByFleet"                  = plotSelex(s,
                                                                ...
                                                                figtype = figtype,
                                                                showtitle = showtitle),
           "sSelexLogisticByFleetAllGears"          = plotSelex(s,
                                                                2,
                                                                savefig,
                                                                "Selex-All-Gears",
                                                                plotMCMC,
                                                                ...
                                                                figtype = figtype,
                                                                showtitle = showtitle),
           "sSelexMaturity"                         = plotSelex(s,
                                                                2,
                                                                savefig,
                                                                "Selex-All-Gears-Maturity",
                                                                plotMCMC,
                                                                ci,
                                                                sensGroup = sgr,
                                                                ps = ps,
                                                                ...
                                                                showtitle = showtitle,
                                                                showmat = TRUE,
                                                                use.bio.for.mat = val$useBioForMat),
           "sSelexLogisticByFleetAllEstGears"       = plotSelex(s,
                                                                2,
                                                                savefig,
                                                                "Selex-All-Estimated-Gears",
                                                                plotMCMC,
                                                                ci,
                                                                sensGroup = sgr,
                                                                ps = ps,
                                                                ...
                                                                showtitle = showtitle,
                                                                plot.fixed = FALSE),
           "sSelexMaturityEstGears"                 = plotSelex(s,
                                                                2,
                                                                savefig,
                                                                "Selex-All-Gears-Maturity-Est-Gears",
                                                                plotMCMC,
                                                                ci,
                                                                sensGroup = sgr,
                                                                ps = ps,
