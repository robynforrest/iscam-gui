...
.doPlots <- function(png=TRUE){
  ...
  if(.checkEntries()){
    ...
    switch(pType,
           ...
           "sCatchLandings"                         = {plotCatch(1,png,"CatchLandings",plotMCMC,ci,sensGroup=sgr,index=ind)},
           "sCatchLandingsStacked"                  = {plotCatch(2,png,"CatchLandingsStacked",plotMCMC,ci,sensGroup=sgr,index=ind)},
           "sCatchLandingsObsVsExpLandings"         = {plotCatch(3,png,"CatchLandingsObsVsExpLandings",plotMCMC,ci,sensGroup=sgr,index=ind)},
           "sCatchTotal"                            = {plotCatch(4,png,"CatchTotal",plotMCMC,ci,sensGroup=sgr,index=ind)},
           "sCatchTotalStacked"                     = {plotCatch(5,png,"CatchTotalStacked",plotMCMC,ci,sensGroup=sgr,index=ind)},
           "sCatchDiscards"                         = {plotCatch(6,png,"CatchDiscards",plotMCMC,ci,sensGroup=sgr,index=ind)},
