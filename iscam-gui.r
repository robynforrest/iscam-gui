...
.doPlots <- function(savefig=.SAVEFIG){
  ...
  if(.checkEntries()){
   ...
   switch(pType,
           ...
           "sTSSpawningBiomassAllAreas"             = {plotTS(s,1,savefig,"SpawningBiomassAllAreas",plotMCMC,ci,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sTSSpawningBiomassByArea"               = {plotTS(s,2,savefig,"SpawningBiomassByArea",plotMCMC,ci,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sTSVulnerableBiomassAllAreas"           = {plotTS(s,12,savefig,"VulnerableBiomass",plotMCMC,ci,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sTSVSBiomassAllAreas"                   = {plotTS(s,12,savefig,"VulnerableBiomass",plotMCMC,ci,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle, showSbio=TRUE)},
           "sTSSpawningDepletionAllAreas"           = {plotTS(s,3,savefig,"SpawningDepletionAllAreas",plotMCMC,ci,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sTSSpawningDepletionByArea"             = {plotTS(s,4,savefig,"SpawningDepletionByArea",plotMCMC,ci,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sTSRecruitmentAllAreas"                 = {plotTS(s,5,savefig,"RecruitmentAllAreas",plotMCMC,ci,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sTSRecruitmentDevsAllAreas"             = {plotTS(s,11,savefig,"RecruitmentDevsAllAreas",plotMCMC,ci,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sTSRecruitmentByArea"                   = {plotTS(s,6,savefig,"RecruitmentByArea",plotMCMC,ci,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           # Only MPD for Index
           ...
           "sFishingMortality"                      = {plotTS(s,9,savefig,"FishingMortalityF",plotMCMC,ci,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sFishingMortalityU"                     = {plotTS(s,9,savefig,"FishingMortalityU",plotMCMC,ci,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle, plotU=TRUE)},
           ...
           "sBiologyMeanWtAtAge"                    = {plotBiology(1,compFitSex,savefig,"BiologyMeanWtAtAge",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyMaturityAtAge"                  = {plotBiology(2,compFitSex,savefig,"BiologyMaturityAtAge",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyFecundity"                      = {plotBiology(3,compFitSex,savefig,"BiologyFecundity",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyFecundityWeight"                = {plotBiology(4,compFitSex,savefig,"BiologyFecundityWeight",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyFecundityLength"                = {plotBiology(5,compFitSex,savefig,"BiologyFecundityLength",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologySpawnOutputLength"              = {plotBiology(6,compFitSex,savefig,"BiologySpawnOutputLength",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyExpectedGrowth"                 = {plotBiology(7,compFitSex,savefig,"BiologyExpectedGrowth",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyTVM"                            = {plotBiology(8,compFitSex,savefig,"BiologyTVM",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyTVGrowthPersp"                  = {plotBiology(9,compFitSex,savefig,"BiologyTVGrowthPersp",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyTVGrowthContour"                = {plotBiology(10,compFitSex,savefig,"BiologyTVGrowthContour",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyComposition"                    = {plotBiology(11,compFitSex,savefig,"BiologyComposition",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
          # Can delete this special one after ARF assessment
           "sBiologyCompositionSpecial"             = {plotBiology(99,compFitSex,savefig,"BiologyCompositionSpecial",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyCompositionN1"                  = {plotBiology(10,compFitSex,savefig,"BiologyCompositionN1",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyCompositionFit"                 = {plotBiology(12,compFitSex,savefig,"BiologyCompositionFit",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyCompositionResid"               = {plotBiology(13,compFitSex,savefig,"BiologyCompositionResiduals",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyLW"                             = {plotBiology(14,compFitSex,savefig,"BiologyLengthWeightRelationship",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyVONB"                           = {plotBiology(15,compFitSex,savefig,"BiologyVonBRelationship",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sBiologyMA"                             = {plotBiology(16,compFitSex,savefig,"BiologyMaturityAgeRelationship",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           ...
           "sSelexLogisticByFleet"                  = {plotSelex(s,1,savefig,"SelexLogisticByFleet",plotMCMC,ci,sensGroup=sgr,ps=ps,leg=leg,index=ind,figtype=figtype,showtitle=showtitle)},
           # From iscam-gui-figures-catch.r
           "sCatchLandings"                         = {plotCatch(s,1,savefig,"CatchLandings",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           #"sCatchLandingsStacked"                  = {plotCatch(s,2,savefig,"CatchLandingsStacked",plotMCMC,ci,sensGroup=sgr,index=ind)},
           "sCatchLandingsObsVsExpLandings"         = {plotCatch(s,3,savefig,"CatchLandingsObsVsExpLandings",plotMCMC,ci,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sCatchAnnualMeanWt" 		                = {plotCatch(s,4,savefig,"CatchFitAnnualMeanWeight",plotMCMC,ci,sensGroup=sgr,index=ind,figtype=figtype,showtitle=showtitle)},
           ...
           "sPriorsVsPosts"                         = {plotConvergence(s,5,savefig,"PriorsPosteriors",ps=ps,burnthin=burnthin,figtype=figtype,showtitle=showtitle,exFactor=1.5,showEntirePrior=T)},
           ...
           # From iscam-gui-figures-timeseries.r
           "sSensSB"                                = {plotTS(s,1,savefig,"SpawningBiomass",plotMCMC,ci,multiple=TRUE,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sSensVB"                                = {plotTS(s,12,savefig,"VulnerableBiomass",plotMCMC,ci,multiple=TRUE,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sSensBRatio"                            = {plotTS(s,3,savefig,"Depletion",plotMCMC,ci,multiple=TRUE,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sSensRecruit"                           = {plotTS(s,5,savefig,"Recruitment",plotMCMC,ci,multiple=TRUE,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle,recrOffset=val$entryRecrOffset)},
           # No sensitivity plot for MCMC Indices
           "sSensIndex"                             = {plotTS(s,7,savefig,"Index",FALSE,ci,multiple=TRUE,sensGroup=sgr,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           ...
           "sSensSelex"                              = {plotSelex(s,1,savefig,"SelexLogisticByFleet",plotMCMC,ci,multiple=TRUE,sensGroup=sgr,index=ind,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},

           # Plot Retrospectives
           "sRetroSB"                               = {plotTS(s,1,savefig,"RetroSpawningBiomass",retros=TRUE,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sRetroD"                                = {plotTS(s,3,savefig,"RetroDepletion",retros=TRUE,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           "sRetroRec"                              = {plotTS(s,5,savefig,"RetroSpawningBiomass",retros=TRUE,index=ind,burnthin=burnthin,ps=ps,leg=leg,figtype=figtype,showtitle=showtitle)},
           ...
           "sObjFuncVal"                            = {plotDiagnostics(s, 1, savefig,"ObjectiveFunctionValue",burnthin=burnthin,figtype=figtype,showtitle=showtitle)},
           "sMaxGrad"                               = {plotDiagnostics(s, 2, savefig,"MaximumGradient",burnthin=burnthin,figtype=figtype,showtitle=showtitle)},
           "sFuncEvals"                             = {plotDiagnostics(s, 3, savefig,"FunctionEvaluations",burnthin=burnthin,figtype=figtype,showtitle=showtitle)},
