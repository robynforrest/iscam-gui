...
30.	2.	2.	2.     # 2  -Age at 50% selectivity (logistic) 45
5.1	.5	.5	.5   # 3  -STD at 50% selectivity (logistic)  5.1
0	0	0	0	# 4  -No. of age nodes for each gear (0=ignore)
0	0	0	0	# 5  -No. of year nodes for 2d spline(0=ignore)
2	-2	-3	-4	# 6  -Phase of estimation (negative numbers mirror the settings for the gear with the neg number)
