...
## Note sig = sqrt(rho)*varphi   (sig should be lower than tau)              ##
##      tau = sqrt(1-rho)*varphi                                             ##
##      rho = sig^2/(sig^2+tau^2)
##      varphi = tau/sqrt(1-(sig^2/(sig^2+tau^2)))
## ------------------------------------------------------------------------- ##
## npar
7
## ival      lb   ub    phz prior p1     p2    #parameter                      ##
   1.0       0.0  10    2   0     0.0    10.0  #log_ro                         ##
   0.8       0.2  1.0  -2   3     9.7666  2.803034 #steepness                      ##
  -1.204    -3.0  2.0   1   1    -1.204   0.15  #log_m g&b                      ##
   1.0       0.0  10    1   0     0.0    10    #log_avgrec                     ##
   1.0       0.0  10    1   0     0.0    10    #log_recinit                    ##
   0.0889    0.01 0.99  2   3     3.0    12.0  #rho                            ##
   1.4234    0.01 5.0   3   4     7.49836 5.78354 #vartheta (also called kappa)   ##
## -------------------------------------------------------------------------  ##
##
## ------------------------------------------------------------------------- ##
