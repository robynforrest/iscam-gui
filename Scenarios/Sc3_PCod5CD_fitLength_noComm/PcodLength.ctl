...
2.	2.	2.	2.     # 2  -Age at 50% selectivity (logistic) 45
0.5	0.5	0.5	0.5   # 3  -STD at 50% selectivity (logistic)  5.1
0	0	0	0	# 4  -No. of age nodes for each gear (0=ignore)
0	0	0	0	# 5  -No. of year nodes for 2d spline(0=ignore)
-1	-2	-3	-4	# 6  -Phase of estimation (negative numbers mirror the settings for the gear with the neg number)
...
0.2  #sd for likelihood for fitting to annual mean weight (one for each series) ::  vector weight_sig(1,nMeanWtCV)	        //END_RF_ADD
## ------------------------------------------------------------------------- ##
##
## ------------------------------------------------------------------------- ##
