...
## ------------------------------------------------------------------------- ##
6	11	11	6	 # 1  -selectivity type ivector(isel_type) for gear  11
2.	30.	30.	2.     # 2  -Age at 50% selectivity (logistic) 45
.5	2.1	2.1	0.3   # 3  -STD at 50% selectivity (logistic)  5.1
0	0	0	0	# 4  -No. of age nodes for each gear (0=ignore)
0	0	0	0	# 5  -No. of year nodes for 2d spline(0=ignore)
-1	-2	-2	-4	# 6  -Phase of estimation (negative numbers mirror the settings for the gear with the neg number)
...
0.15  #sd for likelihood for fitting to annual mean weight (one for each series) ::  vector weight_sig(1,nMeanWtCV)	        //END_RF_ADD
## ------------------------------------------------------------------------- ##
##
## ------------------------------------------------------------------------- ##
...
1.        # 6  -Maternal effects parameter
...
0.10        # 13 -fraction of total mortality that takes place prior to spawning
