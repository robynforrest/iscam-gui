...
DATA_SECTION
  ...
  // but the header data.
	...
	// |---------------------------------------------------------------------------------|
	// | EMPIRICAL ANNUAL MEAN WEIGHT DATA (RAGGED ARRAY) -- RF ADDED THIS FOR TESTING WITH PACIFIC COD DATA		  //START_RF_ADD
	// |---------------------------------------------------------------------------------|
	// | FITTING TO ANNUAL MEAN WEIGHTS REQUIRES SWITCHING THIS ON AND SETTING VARIANCE  IN CONTROL FILE 
	// |---------------------------------------------------------------------------------|
	...
	init_3darray d3_mean_wt_data(1,nMeanWt,1,nMeanWtNobs,1,7);			  //END_RF_ADD
